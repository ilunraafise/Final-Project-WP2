                              ...
                              <?php echo $mem->status ?>
                                ...
                                if($this->session->userdata('access_level')==1)
                                {
                                  ...
                                  <td class="text-right">                                    
                                    ...
                                    <button type="button" onclick="del_member(<?php echo $mem->id ?>,'<?php echo $mem->member_name ?>')" class="btn btn-link btn-danger btn-just-icon remove"><i class="material-icons">close</i>                                  
                          </td>
                                  <?php
                                }
                                ?>
